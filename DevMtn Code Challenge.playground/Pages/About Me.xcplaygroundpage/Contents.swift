...
var age = 23
let hometown = "SLC"
let classReason = "I want to become a developer"
...
print("My name is \(firstName) \(lastName), I am \(age) years old, I am from \(hometown), and I like to \(hobbies[0]), \(hobbies[1]), and go \(hobbies[2]).")
